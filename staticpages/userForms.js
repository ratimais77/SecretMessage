...
var MainPage = function (_React$Component) {
    ...
    _createClass(MainPage, [{
        key: 'setStateByChild',
        value: function setStateByChild(stateObj) {
        ...
        value: function render() {
            ...
            if (!this.state.loggedIn) {
                resp = React.createElement(LoginForm, { setOwnerState: this.setStateByChild.bind(this) });
            } else {
                resp = React.createElement(UserViewTop, { setOwnerState: this.setStateByChild.bind(this) });
            }
